...
export class GBNSender extends Node{
    ...
    constructor({
        ...
        super();
        /**
         * @member {Timeout} - The current timeout object of the window.
         * @private
         */

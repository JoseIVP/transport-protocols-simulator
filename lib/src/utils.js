...
export class StatsComputer{
     ...
     */
    get packetsSentPerSecond() { return this._packetsSent / this._duration * 1000; }
    /** 
     ...
     */
    get packetsReceivedPerSecond(){ return this._packetsReceived / this._duration * 1000; }
    /** 
     ...
     */
    get packetsReceivedOkPerSecond(){ return this._packetsReceivedOk / this._duration * 1000; }
    /** 
     * @member {number} - The number of packets re-sent by the sender in the
     * last interval divided by updateTime converted to seconds.
     */
    get packetsReSentPerSecond(){ return this._packetsReSent / this._duration * 1000; }
    /** 
     ...
     */
    get acksSentPerSecond(){ return this._acksSent / this._duration * 1000; }
    /** 
     ...
     */
    get acksReceivedPerSecond(){ return this._acksReceived / this._duration * 1000; }
    /** 
     ...
     * seconds.
     */
    get acksReceivedOkPerSecond(){ return this._acksReceivedOk / this._duration * 1000; }

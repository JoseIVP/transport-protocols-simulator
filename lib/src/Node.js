...
class Node{
    ...
    /**
     * Override this callback to listen for started timeouts.
     * @param {number} seqNum - The sequence number of the timeout.
     */
    onTimeoutSet(seqNum){
        return;
    }
    ...
    /**
     * Override this callback to listen for stopped timeouts.
     * @param {number} seqNum - The sequence number of the timeout.
     */

        ...
        describe("#send()", function(){
            ...
            it("should set a timeout for sending a new packet for the current unacknowledged sequence", function(done){
                ...
                setTimeout(()=> {
                    ...
                    // Now the receiver should have received the resent packet
